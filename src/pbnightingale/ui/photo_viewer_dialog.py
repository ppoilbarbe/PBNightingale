...
(with scrollbars if it doesn't fit the window). Opened by activating a photo
in the key detail panel — double-click or Enter, both delivered by Qt's
``itemActivated`` signal, see ``KeyListView._on_photo_activated()``."""
