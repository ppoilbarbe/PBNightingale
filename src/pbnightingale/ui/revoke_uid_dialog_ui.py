"""UI layout for the Revoke User ID dialog (strong confirmation required)."""
...
class Ui_RevokeUidDialog(KeyOperationDialogUiMixin):
    def setupUi(self, dialog: QDialog) -> None:
        dialog.setWindowTitle(_("Revoke User ID"))
